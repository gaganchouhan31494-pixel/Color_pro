        ...
        >
          ...
          <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-2xl bg-gradient-to-b from-amber-300 via-amber-400 to-amber-600 p-0.5 shadow-md shrink-0 transition-transform group-active:scale-95">
            <div
              className={`w-full h-full rounded-[14px] flex items-center justify-center ${
                isLight ? 'bg-white text-zinc-950' : 'bg-zinc-950 text-white'
              }`}
            >
          ...
          <div className="min-w-0">
            <div className="flex items-center gap-1">
              <h1
                className={`font-black text-xs sm:text-base md:text-lg tracking-tight truncate max-w-[95px] xs:max-w-[130px] sm:max-w-none leading-tight ${
            ...
            <p
              className={`text-[9px] sm:text-[10px] leading-none hidden sm:block font-medium mt-0.5 ${
        ...
        <div className="flex items-center gap-1 sm:gap-2 shrink-0">
          ...
          {user.isLoggedIn ? (
            <button
              ...
              className={`hidden xs:flex items-center gap-1.5 border px-2.5 py-1 rounded-full transition-all active:scale-95 ${
                isLight
            ...
            <button
              id="header-login-btn"
              onClick={onOpenAuth}
              className={`hidden xs:flex items-center gap-1 px-3 py-1.5 rounded-xl text-xs font-black shadow active:scale-95 transition-all ${
                isLight
